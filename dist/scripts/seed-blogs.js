...
const blogsData = [
    {
      ...
      <p>To break into this field, you will need a combination of technical and soft skills. Starting with SQL for database querying, Python or R for programming, and visualization tools like Power BI or Tableau will give you a solid foundation.</p>
    `
    },
    {
        ...
        content: `
      <h2>The Art of Dashboard Design</h2>
    ...
    },
    {
        ...
        imageUrl: "https://images.unsplash.com/photo-1521791136368-1a8b27503462?q=80&w=600&auto=format&fit=crop",
        content: `
      ...
      <p>Make sure to host your projects on GitHub or hosting platforms, and write clean, descriptive README files that summarize your findings and business impact.</p>
    `
    },
    {
    ...
    },
    {
      ...
      <p>Writing query code that runs on small test datasets is simple. However, running those same queries on production tables with millions of rows can cause severe performance bottlenecks. Here are the core SQL best practices you need to follow:</p>
      <ul>
    ...
    },
    {
      ...
      <p>Monitoring these trends allows companies to adapt their strategy, optimize marketing spend, and improve customer retention programs before problems escalate.</p>
    `
    },
    {
...
async function main() {
    console.log("Starting database seeding for Blogs...");
    // Clean existing blogs
    await prisma.blog.deleteMany({});
    console.log("Cleared existing blogs from database.");
    // Insert blogs and images
