...
exports.seedBlogs = exports.deleteBlog = exports.updateBlog = exports.createBlog = exports.getBlog = exports.getBlogs = void 0;
...
const seedBlogs = async (req, res) => {
    ...
    try {
        ...
        await prismadb_1.prismadb.blog.deleteMany({});
