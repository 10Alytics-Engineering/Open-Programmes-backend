...
exports.default = (router) => {
    ...
    router.delete("/courses/:courseId", middleware_1.isSuperAdmin, course_1.deleteCourse);
    ...
    router.patch("/courses/:courseId/publish", middleware_1.isCourseAdmin, course_1.publishCourse);
    router.patch("/courses/:courseId/unpublish", middleware_1.isCourseAdmin, course_1.unpublishCourse);
};
